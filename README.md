...
- [x] 사용자에게 구매할 상품과 수량을 입력받는다.
  ...
  - [x] 각 상품의 재고 수량을 고려하여 결제 가능 여부를 확인하고, 구매한 상품은 해당 상품의 재고에서 차감한다.
  - [x] 재고를 차감함으로써 시스템은 최신 재고 목록을 유지한다.
- [x] 프로모션 확인
...
- [x] 함수는 한 가지 일만 하도록 작게 만들며 10라인이 넘어가지 않도록 한다.
